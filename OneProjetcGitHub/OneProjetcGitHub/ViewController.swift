...
class ViewController: UIViewController {
    ...
    Rock(name: "RAIMUNDOS", bibliography: "Raimundos é uma banda de rock brasileira formada em Brasília em 1987. O nome é derivado de uma de suas maiores influências, a banda Ramones. Com oito discos autorais, trinta anos de existência e mais de cinco milhões de cópias vendidas, é uma das principais bandas dos anos 90.", members: "Formação atual: Digão: bateria, Canisso, Marquim, Caio Cunha. Ex-integrantes: Rodolfo Abrantes, Fred", topMusic: "A Mais Pedida, Mulher de Fases, Eu Quero Ver o Oco", image: "raimundos")
    ]
